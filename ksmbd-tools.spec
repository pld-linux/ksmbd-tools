...
# Source0-md5:	b138bd001d5a85e93b0d887c3e4fe212
...
%dir %attr(750,root,root) %{_sysconfdir}/ksmbd
%attr(640,root,root) %config(noreplace) %verify(not md5 mtime size) %{_sysconfdir}/ksmbd/ksmbd.conf
